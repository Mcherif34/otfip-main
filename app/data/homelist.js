...
export const HomeListData = [
  {
    id: '1',
    image: Images.main_doc,
    title: 'Note de conjoncture sur le secteur pétrolier au premier trimestre 2022',
    subtitle: 'Budget général',
    date: '30 juin 2022',
    content: `Comparativement au 1er trimestre 2021, le Trésor public enregistre une augmentation des recettes pétrolières au premier trimestre 2022.
Ceci, en lien avec la hausse du cours du Brent et la dépréciation du taux de change FCFA/USD, et ce malgré la baisse des volumes de la production et des exportations.
Quant au secteur aval, la consommation du fuel lourd, du gasoil et du kérosène diminue, exceptée celle de gaz de pétrole liquéfié (GPL) et de l’essence.`,
  },
  {
    id: '2',
    image: Images.main_doc,
    title: 'Rapport sur l’evaluation des Depenses fiscales exercice 2022',
    subtitle: 'Budget général',
    date: '07 juin 2023',
...
The fact that so many people watch sporting events makes broadcasts attractive targets for attackers with a message. Islamist hackers have attacked French and Israeli broadcasts in recent years, including disrupting the Eurovision song contest to send false missile alerts.`,
  },
  {
    id: '3',
    image: Images.main_doc,
    title: 'Liste des exonérations fiscales exercice 2022',
    subtitle: 'Budget général',
    date: '07 juin 2023',
